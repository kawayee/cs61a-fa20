...
def totals_tree(m):
    ...
    if(is_planet(m)):
        ...
        return tree(tree_label, [tree_left, tree_right])
...
def par1(r1, r2):
    # mul = interval(r11*r21, r12*r22)
    # add = interval(r11+r21, r12+r22)
    return div_interval(mul_interval(r1, r2), add_interval(r1, r2))

def par2(r1, r2):
    one = interval(1, 1)
    rep_r1 = div_interval(one, r1) # interval(1/r12, 1/r11)
    rep_r2 = div_interval(one, r2) # interval(1/r22, 1/r21)
    # add = interval((r22+r12)/(r12*r22), (r21+r11)/(r11*r21))
...
def check_par():
    ...
    True
    """
    r1 = interval(1, 3) # float cause error
    r2 = interval(1, 1)
    return r1, r2
